    ...
    <div>
      ...
      <div className='flex flex-col gap-4 sm:flex-row items-start mt-5'>
        <div className='flex flex-col gap-4 text-sm text-gray-600'>
          ...
          <p onClick={() => specialist === 'Dermatologist' ? navigate('/doctors/Dermatologist') : navigate('/doctors/Dermatologist')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${specialist === 'Dermatologist' ? 'bg-indigo-100 text-black' : ''}`}>Dermatologist</p>

          <p onClick={() => specialist === 'Pediatricians' ? navigate('/doctors/Pediatricians') : navigate('/doctors/Pediatricians')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${specialist === 'Pediatricians' ? 'bg-indigo-100 text-black' : ''}`}>Pediatricians</p>

          <p onClick={() => specialist === 'Neurologist' ? navigate('/doctors/Neurologist') : navigate('/doctors/Neurologist')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${specialist === 'Neurologist' ? 'bg-indigo-100 text-black' : ''}`}>Neurologist</p>

          <p onClick={() => specialist === 'Gastroenterologist' ? navigate('/doctors/Gastroenterologist') : navigate('/doctors/Gastroenterologist')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${specialist === 'Gastroenterologist' ? 'bg-indigo-100 text-black' : ''}`}>Gastroenterologist</p>
        </div>
